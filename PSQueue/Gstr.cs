    ...
    public class Gstr
    {
        ...
        public static string fncChangeTDate(string strDate)
        {
            ...
            if (strDate.Length == 9)
            {
                ...
                string lvDay = Gstr.fncToInt(lvArr[0]).ToString("00");
                string lvMonth = Gstr.fncToInt(lvArr[1]).ToString("00");
        ...
        public static string FncGetTimeOnly(string lvTime,string lvFormat)
        {
            string lvReturn = "";
